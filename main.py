...
token = 'TOKEN'  # This is where your discord bot token should go (string)
channel_id = 'channel_id'  # This is where you should put the channel id of where you want the bot to play in (integer)
